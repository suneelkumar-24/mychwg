<div class="tab-pane fade show active">
    <div class="text-center materia_logo">
        <img src="{{ asset('front/assets/materia_faction.png')}}">
            ...
            <div class="form-group">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="invalidCheck3">
                    I have reviewed and accept the <a href="{{ route('terms') }}" target="_blank">Terms & Conditions</a> for using Materia Faction.
                  </label>
                </div>
              </div>
