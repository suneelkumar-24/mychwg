    ...
    <div id="welcome">
        ...
        <div class="row">
            <div class="col-md-12" style="margin-top:20px; min-height: 300px;">
                ...
                <form id="searchCanvasForm" action="{{ url()->current() }}" method="get">
                    ...
                    <p style="padding-top: 10px;">Some common focuses include:</p>
                        <div class="btns">
                            @foreach($specializations as $key => $value)
                                <a class="btn btn-focus" onclick="setFocusValue('{{ $value }}')"
...
<div id="slide-down-circle" style="left:40%">
    {{-- <img src="{{ asset('front/assets/move.gif') }}" style="height:50px;cursor:pointer"> --}}
