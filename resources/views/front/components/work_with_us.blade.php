...
<div class="inner">
<h1 class="heading gotham-bold" style="font-size:60px;font-weight:600;">{{$setting['about_bottom_section_heading'] ?? ''}}</h1>
<p style="max-width:600px; margin:0 auto;" class="gotham-black">{{$setting['about_bottom_section_description'] ?? ''}}
    <br> <br>
