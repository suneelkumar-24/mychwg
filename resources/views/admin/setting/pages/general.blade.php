                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$setting['login_page_subheading'] ?? ''}}" name="login_page_subheading" class="form-control">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class=" dropify dropify-event" name="inner_page_banner_image" data-default-file="{{ asset($setting['inner_page_banner_image'] ?? '')  }}">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class=" dropify dropify-event" name="other_inner_page_banner_image" data-default-file="{{ asset($setting['other_inner_page_banner_image'] ?? '')  }}">
