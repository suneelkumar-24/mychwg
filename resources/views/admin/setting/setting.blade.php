                            ...
                            <table class="table p-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('homeopathy.practitioners') }}" target="_blank" class="btn btn-success w-100 font-weight-bold">Visit Page</a></td>
                                        <th class="text-right">
                                            
                                            <a href="{{ route('admin.setting.practitioners') }}" class="btn btn-primary w-100 font-weight-bold">Update Practitioners</a>
                                        </th>
                                    </tr>
