            ...
            <div class="card-body">
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <h3 class="text-primary font-weight-bold">CAD {{ $this_month_revenue ?? 0 }}</h3>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Last Month Revenue</strong>
                    <h3 class="text-primary font-weight-bold">CAD {{ $last_month_revenue ?? 0 }}</h3>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Overall Revenue</strong>
                    <h3 class="text-primary font-weight-bold">CAD {{ $total ?? 0 }}</h3>
                  </li>
                                ...
                                <tbody>
                                    @foreach($services as $item)
                                        <tr>
                                            ...
                                            <td><h3 class="text-success font-weight-bold">CAD {{ $item->price }}</h3></td>
