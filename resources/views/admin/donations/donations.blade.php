...
<div class="row">
    ...
    <div class="col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex align-items-start pb-0">
                                    <div>
                                        <h2 class="text-bold-700 mb-0 text-primary">CAD {{ $total ?? 0 }}</h2>
    ...
    <div class="col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex align-items-start pb-0">
                                    <div>
                                        <h2 class="text-bold-700 mb-0 text-success">CAD {{ $this_month_donation ?? 0 }}</h2>
                            ...
                            <table class="table datatable p-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge badge-info">CAD {{ $item->price ?? 'N/A' }}</span></td>
