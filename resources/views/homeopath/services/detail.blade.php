                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <div class="float-right">
                                ...
                                <span class="badge badge-primary">CAD ${{ number_format($service->price, 2) }}</span>
...
<div class="text-center mb-3">
    ...
    <a href="{{ route('homeopath.services.book.appointment', Crypt::encrypt($service->id)) }}" class="font-weight-bold border-0 btn bg-success text-white">+ Add a manual appointment</a>
...
<div class="row documents__form">
    ...
    @include('homeopath.services.forms.form_1')

    @include('homeopath.services.forms.form_2')

    @include('homeopath.services.forms.form_3')

    @include('homeopath.services.forms.form_4')    
                ...
                <form method="post" action="{{ route('homeopath.services.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" name="is_show_additional_doc">
                            ...
                            <option value="{{ $service->is_show_additional_doc }}" selected="" hidden="">{{ $service->is_show_additional_doc }}</option>
