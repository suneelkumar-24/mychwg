<div class="col-lg-6 mb-3">
    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            ...
            <a href="{{ asset($service->adult_service_document ?? '') }}" target="_blank" class="btn btn-dark btn-block">View Uploaded Form</a>
            ...
            <form method="POST" action="{{ route('homeopath.settings.update.images') }}" enctype="multipart/form-data">
                ...
                <div class="row main-item-images">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 mb-2">
                        ...
                        <input type="text" class="form-control" name="service_document_heading" value="{{ $service->service_document_heading ?? '' }}" >
