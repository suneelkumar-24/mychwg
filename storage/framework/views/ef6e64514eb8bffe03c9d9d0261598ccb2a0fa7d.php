                ...
                <tbody>
                    <tr>
                        <td style="padding: 48px 24px 0; color: #161c2d; font-size: 18px; font-weight: 600;">
                            <?php echo e(emailSetting('register_advocate')->hello??''); ?>

                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            <?php echo emailSetting('register_advocate')->desc??''; ?>

                        </td>
                    </tr>

                    <?php if(emailSetting('register_advocate')->image??''): ?>
                    <tr>
                       <td style="padding: 15px 24px 15px; color: #8492a6;">
                    ...
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            <?php echo e(emailSetting('register_advocate')->team??''); ?>
...
<?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/email/advocate/registered_advocate.blade.php ENDPATH**/ ?>