            ...
            <div class="row text-center">
                <div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 image-title">
                        <span style="font-weight:bold;font-size:30px;text-align: center;" class="gotham-bold"><?php echo e($setting['mission_stat_1st_heading'] ?? ''); ?></span>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12 image-description">
                        <p class="gotham-black"><?php echo e($setting['mission_stat_1st_description'] ?? ''); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 image-title">
                    <span class="gotham-bold" style="font-weight:bold;font-size:30px;"><?php echo e($setting['mission_stat_2nd_heading'] ?? ''); ?></span>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12 image-description">
                    <p class="gotham-black"><?php echo e($setting['mission_stat_2nd_description'] ?? ''); ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
...
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
<span class="gotham-bold" style="font-weight:bold;font-size:30px;"><?php echo e($setting['mission_stat_3rd_heading'] ?? ''); ?></span>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-description">
<p class="gotham-black"><?php echo e($setting['mission_stat_3rd_description'] ?? ''); ?></p>
</div>
</div>
</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
<span style="font-weight:bold;font-size:30px;" class="gotham-bold"><?php echo e($setting['mission_stat_4th_heading'] ?? ''); ?></span>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-description">
<p class="gotham-black"><?php echo e($setting['mission_stat_4th_description'] ?? ''); ?></p>
</div>
</div>
</div>
<div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
...
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
<span class="gotham-bold" style="font-weight:bold;font-size:30px;"><?php echo e($setting['mission_stat_5th_heading'] ?? ''); ?></span>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-description">
<p class="gotham-black"><?php echo e($setting['mission_stat_5th_description'] ?? ''); ?></p>
</div>
</div>
</div>
<div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
...
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
<span class="gotham-bold" style="font-weight:bold;font-size:30px;"><?php echo e($setting['mission_stat_6th_heading'] ?? ''); ?></span>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-description">
<p class="gotham-black"><?php echo e($setting['mission_stat_6th_description'] ?? ''); ?></p>
</div>
</div>
</div>
</div>
