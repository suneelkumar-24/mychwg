                ...
                <div class="p-1">
                    <div class="row w-100">
                        ...
                        <div class="col-md-6 pr-0 text-right">
                            <button class="btn btn-primary btn-add-category btn-sm" data-action="<?php echo e(route('admin.shop.category.create')); ?>">+ New Category</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
                <div class="p-1">
                    <div class="row w-100">
                        ...
                        <div class="col-md-6 pr-0 text-right">
                            <button class="btn btn-primary btn-add-brand btn-sm" data-action="<?php echo e(route('admin.shop.brand.create')); ?>">+ New Brand</button>
                        </div>
                    </div>
                </div>
                <div class="card-content">
        ...
        <div class="card">
                <div class="p-1">
                    <div class="row w-100">
                        ...
                        <div class="col-md-6 pr-0 text-right">
                            <button class="btn btn-primary btn-add-variant btn-sm" data-action="<?php echo e(route('admin.shop.variant.create')); ?>">+ New Variant</button>
                        </div>
                    </div>
                </div>
                <div class="card-content">
        ...
        <div class="card">
                <div class="p-1">
                    <div class="row w-100">
                        ...
                        <div class="col-md-6 pr-0 text-right">
                            <button class="btn btn-primary btn-add-color btn-sm" data-action="<?php echo e(route('admin.shop.color.create')); ?>">+ New color</button>
                        </div>
                    </div>
                </div>
                <div class="card-content">
