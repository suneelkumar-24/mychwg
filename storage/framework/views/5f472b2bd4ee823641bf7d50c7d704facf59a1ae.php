                                ...
                                <table class="table datatable p-0 table-hover-animation">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="tr">
                                            ...
                                            <td class="td"><a href="#" data-toggle="modal" data-target="#serviceTexModal1" class="btn btn-warning btn-sm edit-tax-btn" data-service-comission="<?php echo e($item->service_commission??''); ?>" data-service-tax="<?php echo e($item->service_tax??''); ?>" data-service-discount="<?php echo e($item->service_discount??''); ?>" data-location="<?php echo e($item->location??''); ?>"><i class="fa fa-edit"></i></a></td>
