      <div class="container container-book-appointment mb-4" style="border:5px solid #58C763;">
        ...
        <div class="appointment-banner  pt-3 pb-1" style="background-image:url('<?php echo e(asset($service->ServiceTheme->cover)); ?>')">
          ...
          <strong class="float-right pr-4" style="color: <?php echo e($service->ServiceTheme->color ?? '#000'); ?>;">3 of 4</strong>
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="col-lg-12 col-sm-12">
                  <?php if($homeopath->square_location_id && $homeopath->square_app_id && $homeopath->square_access_token): ?>
...
<?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/front/services/appointment-booking/slide_3.blade.php ENDPATH**/ ?>