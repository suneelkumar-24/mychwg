                    ...
                    <div class="row">
                        <div class="col-md-6 banner-left-bar">
                            <div class="hero__copy">
                                ...
                                <p class="gotham-black"><?php echo e($setting['banner_description'] ?? ''); ?></p>
...
<section class="content">
    ...
    <div class="banner2">
        <div class="container">
            <div class="row align-center">
                <div class="col-sm-9">
                    <h2 class="quarto-semibold"><?php echo e($setting['reopening_journey_heading'] ?? ''); ?></h2>
                    <p class="gotham-black"><?php echo e($setting['reopening_journey_description'] ?? ''); ?></p>
                </div>
    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-sm-5 text-center box1 mb-5">
                ...
                <h2 class="bol black-color"><?php echo e($setting['chwg_for_advocates'] ?? 'CHWG for Advocates'); ?></h2>
                <p class="gotham-black black-color"><?php echo e($setting['chwg_for_advocates_description'] ?? ''); ?></p>
            ...
            <div class="col-sm-5 text-center box1 mb-5">
                ...
                <h2 class="bol black-color"><?php echo e($setting['chwg_for_homeopaths'] ?? 'CHWG for Homeopaths'); ?></h2>
                <p class="gotham-black black-color"><?php echo e($setting['chwg_for_homeopaths_description'] ?? ''); ?></p>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="product1">
                        ...
                        <div class="inner">
                            <h3 class="gotham-bold"><?php echo e($setting['helpful_resource_1st_heading'] ?? ''); ?></h3>
                            <p class="gotham-black"><?php echo e($setting['helpful_resource_1st_description'] ?? ''); ?></p>
                            <a class="gotham-black" href="<?php echo e(route('our.mission')); ?>">Read <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="product1">
                        ...
                        <div class="inner">
                            <h3 class="gotham-bold"><?php echo e($setting['helpful_resource_2nd_heading'] ?? ''); ?></h3>
                            <p class="gotham-black"><?php echo e($setting['helpful_resource_2nd_description'] ?? ''); ?></p>
                            <a class="gotham-black" href="<?php echo e(route('explore.homeopathy')); ?>">Read <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="product1">
                        ...
                        <div class="inner">
                            <h3 class="gotham-bold"><?php echo e($setting['helpful_resource_3rd_heading'] ?? ''); ?></h3>
                            <p class="gotham-black"><?php echo e($setting['helpful_resource_3rd_description'] ?? ''); ?></p>
                            <a class="gotham-black" href="<?php echo e(route('faqs')); ?>">Read <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="box3">
        <div class="container">
            ...
            <p class="txt21 text-center gotham-black" ><?php echo e($setting['secure_description'] ?? ''); ?></p>
                ...
                <ul>
                    <li class="effect-tb" data-feature-id="documents">
                        <a class="home-tab-documents" href="#documents" >
                            <h4 class="quarto-semibold"><i><?php echo e($setting['what_is_ch_for_homeo_1st_word'] ?? ''); ?></i> <?php echo e($setting['what_is_ch_for_homeo_1st_title'] ?? ''); ?></h4>
                            <p class="txt15 gotham-black"><?php echo e($setting['what_is_ch_for_homeo_1st_summary'] ?? ''); ?></p>
                        </a>
                    </li>
                    <li class="effect-tb" data-feature-id="spreadsheets" >
                        <a class="home-tab-spreadsheets" href="#spreadsheets">
                            <h4 class="quarto-semibold"><i><?php echo e($setting['what_is_ch_for_homeo_2nd_word'] ?? ''); ?></i> <?php echo e($setting['what_is_ch_for_homeo_2nd_title'] ?? ''); ?></h4>
                            <p class="txt15 gotham-black"><?php echo e($setting['what_is_ch_for_homeo_2nd_summary'] ?? ''); ?></p>
                        </a>
                    </li>
                    <li  class="effect-tb" data-feature-id="slides">
                        <a class="home-tab-slides" href="#slides">
                            <h4 class="quarto-semibold"><i><?php echo e($setting['what_is_ch_for_homeo_3rd_word'] ?? ''); ?></i> <?php echo e($setting['what_is_ch_for_homeo_3rd_title'] ?? ''); ?></h4>
                            <p class="txt15 gotham-black"><?php echo e($setting['what_is_ch_for_homeo_3rd_summary'] ?? ''); ?></p>
                        </a>
                    </li>
                    <li class="effect-tb" data-feature-id="chat" >
                        <a class="home-tab-chat" href="#chat">
                            <h4 class="quarto-semibold"><i><?php echo e($setting['what_is_ch_for_homeo_4th_word'] ?? ''); ?></i> <?php echo e($setting['what_is_ch_for_homeo_4th_title'] ?? ''); ?></h4>
                            <p class="txt15 gotham-black"><?php echo e($setting['what_is_ch_for_homeo_4th_summary'] ?? ''); ?></p>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul>
                    <li class="effect-tb2" data-features-id="documents_1">
                        <a class="home-tab-documents_2" href="#documents_1" >
                            <h4 class="quarto-semibold"><i><?php echo e($setting['what_is_ch_for_adv_1st_word'] ?? ''); ?></i> <?php echo e($setting['what_is_ch_for_adv_1st_title'] ?? ''); ?></h4>
                            <p class="txt15 gotham-black"><?php echo e($setting['what_is_ch_for_adv_1st_summary'] ?? ''); ?></p>
                        </a>
                    </li>
                    <li class="effect-tb2" data-features-id="spreadsheets_1" >
                        <a class="home-tab-spreadsheets_2" href="#spreadsheets_1">
                            <h4 class="quarto-semibold"><i><?php echo e($setting['what_is_ch_for_adv_2nd_word'] ?? ''); ?></i> <?php echo e($setting['what_is_ch_for_adv_2nd_title'] ?? ''); ?></h4>
                            <p class="txt15 gotham-black"><?php echo e($setting['what_is_ch_for_adv_2nd_summary'] ?? ''); ?></p>
                        </a>
                    </li>
                    <li  class="effect-tb2" data-features-id="slides_1">
                        <a class="home-tab-slides_2" href="#slides_1">
                            <h4 class="quarto-semibold"><i><?php echo e($setting['what_is_ch_for_adv_3rd_word'] ?? ''); ?></i> <?php echo e($setting['what_is_ch_for_adv_3rd_title'] ?? ''); ?></h4>
                            <p class="txt15 gotham-black"><?php echo e($setting['what_is_ch_for_adv_3rd_summary'] ?? ''); ?></p>
                        </a>
                    </li>
                    <li class="effect-tb2" data-features-id="chat_1" >
                        <a class="home-tab-chat_2" href="#chat_1">
                            <h4 class="quarto-semibold"><i><?php echo e($setting['what_is_ch_for_adv_4th_word'] ?? ''); ?></i> <?php echo e($setting['what_is_ch_for_adv_4th_title'] ?? ''); ?></h4>
                            <p class="txt15 gotham-black"><?php echo e($setting['what_is_ch_for_adv_4th_summary'] ?? ''); ?></p>
                        </a>
                    </li>
                </ul>
            </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/aqib/Downloads/editorconfig/resources/views/front/index.blade.php ENDPATH**/ ?>