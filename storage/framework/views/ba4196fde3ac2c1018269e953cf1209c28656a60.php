...
<form method="post" action="<?php echo e(route('shop.make.checkout')); ?>" id="payment-form">
    <?php echo csrf_field(); ?>
...
<?php $__env->startSection('js'); ?>
  ...
  else 
  {
    ...
    fetch('<?php echo e(route('shop.intent')); ?>', {
      method: 'POST',
     headers: {
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/front/shop/checkout.blade.php ENDPATH**/ ?>