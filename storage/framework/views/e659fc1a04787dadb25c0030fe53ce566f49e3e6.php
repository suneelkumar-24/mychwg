                      ...
                      initialView: 'timeGridWeek',
                                headerToolbar: {
                                        ...
                                        events : [
                                            ...
                                            <?php $__currentLoopData = upcomingEventTimings(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                {
                                                    title : '<?php echo e($item->event->title); ?>',
                                                    start : '<?php echo e($item->date); ?>T<?php echo e($item->time); ?>',
                                                    description: '<?php echo e($item->event->description); ?>',
                                                    className: "event-status",

                                                    extendedProps: {
                                                        id:'<?php echo e($item->id); ?>',
                                                        duration:'<?php echo e($item->time); ?>',
                                                        type:'<?php echo e($item->event->type); ?>',
                                                        description:'<?php echo e($item->event->description); ?>',
                                                    }
...
<script>
    $(document).on('click', '.fc-event-title', function(){
        ...
        $.ajax({
            method:'get',
            url:"<?php echo e(route('social.event.interested')); ?>?id="+$id+'&update_request='+$type,
...
</script><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/vendor/social-network/pages/events_calendar.blade.php ENDPATH**/ ?>