    ...
    <header>
        <div class="wrapper">
            <div id="header_content"
                 style="background:#dcf2fa url(<?php echo e(asset('front/assets')); ?>/templates-assets/header/img/about-us.jpg) no-repeat 50% center;background-size: cover;">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 p-0 m-0 border-right">
                                            <img src="<?php echo e(asset($product->thumbnail)); ?>" class="zoom-image w-100 bg-transparent product-detail-card-img show-product-img" width="100">
                                        </div>
                                        <div class="col-md-6">

                                            <div class="row">
                                                <div class="col-md-6 ">
                                                    <h3 class="text-left"><?php echo e(ucfirst($product->title)); ?></h3>
                                                    <small class="text-center mr-auto"><span class="badge badge-success"><?php echo e(ucfirst($product->shopCategory->title)); ?></span></small>
                                                    <small class="text-center ml-auto"><span class="badge badge-info"><?php echo e(ucfirst($product->shopBrand->title)); ?></span></small>
                                                    <h4 class="mt-3 text-left">Price: <span class="text-success">$<?php echo e($product->amount); ?></span></h4>
                                                    <h4 class="mt-3 text-left">Varient: <span class="text-success"><?php echo e($product->shopVariant->title??''); ?></span></h4>
                                                </div>
                                                <div class="col-md-6 mt-2 text-right">
                                                    <span class="badge badge-primary p-2"><?php echo e($product->type??'New'); ?></span>
                                                    <div class="add-to-cart-btn-div pt-4">
                                                        <input type="button" data-id="<?php echo e($product->uuid); ?>" value="Add to cart" class="form-control btn-outline-success add-to-cart mt-4 cursor-pointer">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mt-4">
                                            ...
                                            <div class="row mt-3 tags-row">
                                                ...
                                                <div class="col-md-12 tags-div">
                                                    <?php $__currentLoopData = commaSeparatedString($product->tags); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <a href="<?php echo e(route('shop.index')); ?>?tag=<?php echo e($tag); ?>" class="btn btn-sm bg-default rounded-0"><i class="fa fa-angle-right"></i> <?php echo e(ucfirst($tag)); ?></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 mt-2">
                                            <select class="select2 select-comparewith-product form-control">
                                                ...
                                                <?php $__currentLoopData = $products_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/front/shop/product-detail.blade.php ENDPATH**/ ?>