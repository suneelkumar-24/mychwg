<div class="col-lg-6 mb-3">
        <h6 class="m-0"><span class="text-white bg-dark p-1">Documents & Forms</span></h6>

    <div class="card mt-3">

        <h5 class="m-0"><span class="text-white bg-info p-1 d-block">Form # 1</span></h5>
        ...
        <div class="card-body">
            ...
            <a href="<?php echo e(asset($service->adult_service_document ?? '')); ?>" target="_blank" class="btn btn-dark btn-block">View Uploaded Form</a>

            <a

                href="<?php echo e(route('homeopath.settings.service.document.remove',

                ['form' => 1 ,'service' => base64_encode($service->id) ])); ?>"
            ...
            <form method="POST" action="<?php echo e(route('homeopath.settings.update.images')); ?>" enctype="multipart/form-data">
                ...
                <div class="row main-item-images">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 mb-2">
                        ...
                        <input type="text" class="form-control" name="service_document_heading" value="<?php echo e($service->service_document_heading ?? ''); ?>" >
...
</div><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/homeopath/services/forms/form_1.blade.php ENDPATH**/ ?>