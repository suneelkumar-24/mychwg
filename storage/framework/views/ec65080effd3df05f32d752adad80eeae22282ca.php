...
<?php $__env->startSection('heading','Service Booking Alert Email'); ?>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" name="first_part" class="form-control small-summernote"><?php echo e($setting->first_part??''); ?></textarea>
                                        </div>
                                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <br>
                                    <h3 id=subject><?php echo html_entity_decode($setting->subject??''); ?></h3>
                                    <p><span id="first_part"><?php echo html_entity_decode($setting->first_part??''); ?> </span><span class="font-weight-bold">Name of User</span></p>
                                    <p><span class="font-weight-bold">Name of Service</span>
                                    <span id="second_part"><?php echo html_entity_decode($setting->second_part??''); ?></span></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/admin/email_setting/service_booking_alert.blade.php ENDPATH**/ ?>