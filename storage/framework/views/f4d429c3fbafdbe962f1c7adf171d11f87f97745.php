...
<?php $__env->startSection('heading','Booking Completed Email'); ?>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><span id="first"><?php echo $setting->first_part??''; ?> </span></p>
                                    <button type="button" class="btn btn-primary text-center mt-1 mb-1">Detail</button>
                                    <p><span id="second"> <?php echo $setting->second_part??''; ?></span></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/admin/email_setting/user/booking_completed_email.blade.php ENDPATH**/ ?>