                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" class="form-control" name="zip_code"
                                                    placeholder="Postal Code" value="<?php echo e(Auth::User()->zip_code ?? ''); ?>" required
                        ...
                        <div class="card-body">
                            ...
                            <div class="clearfix">
                                <div class="float-left1 mb-1">
                                    ...
                                    <a class="btn btn-sm btn-info text-white py-1" style="font-size: small;float: right;" href="<?php echo e(route('user.upgrade-advocate',env('ADVOCATE_YEARLY_PLAN_SQUARE'))); ?>">Subscribe</a>
                                </div>
                            ...
                            <div class="clearfix">
                                <div class="float-left1 mb-1">
                                    ...
                                    <a class="btn btn-sm btn-info text-white py-1" style="font-size: small;float: right;" href="<?php echo e(route('user.upgrade-advocate',env('ADVOCATE_MONTHLY_PLAN_SQUARE'))); ?>">Subscribe</a>
                                </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/user/profile.blade.php ENDPATH**/ ?>