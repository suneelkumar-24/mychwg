...
<?php $__env->startSection('title', $setting['mission_title'] ?? ''); ?>

<?php $__env->startSection('meta'); ?>
    <meta name="keywords" content="<?php echo e($setting['mission_keywords'] ?? ''); ?>">
    <meta name="description" content="<?php echo e($setting['mission_description'] ?? ''); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

<?php echo $__env->make('front.components.pages_banner', ['heading' => $setting['mission_title'] ?? '', 'description' => $setting['mission_description'] ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="py-4"  style="background-color:#F2F2F2 ;">
            <div class="container text-center">
                ...
                <p style="margin:0 auto; max-width:849px">
                    <?php echo e($setting['mission_statemtnt_heading'] ?? ''); ?>
            ...
            <div class="row text-center">
                <div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 image-title">
                        <span style="font-family:poppins-semibold,poppins,sans-serif;font-weight:bold;font-size:30px;text-align: center;"><?php echo e($setting['mission_stat_1st_heading'] ?? ''); ?></span>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12 image-description">
                        <p><?php echo e($setting['mission_stat_1st_description'] ?? ''); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 image-title">
                    <span style="font-family:poppins-semibold,poppins,sans-serif;font-weight:bold;font-size:30px;"><?php echo e($setting['mission_stat_2nd_heading'] ?? ''); ?></span>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12 image-description">
                    <p><?php echo e($setting['mission_stat_2nd_description'] ?? ''); ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
...
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
<span style="font-family:poppins-semibold,poppins,sans-serif;font-weight:bold;font-size:30px;"><?php echo e($setting['mission_stat_3rd_heading'] ?? ''); ?></span>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-description">
<p><?php echo e($setting['mission_stat_3rd_description'] ?? ''); ?></p>
</div>
</div>
</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
<span style="font-family:poppins-semibold,poppins,sans-serif;font-weight:bold;font-size:30px;"><?php echo e($setting['mission_stat_4th_heading'] ?? ''); ?></span>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-description">
<p><?php echo e($setting['mission_stat_4th_description'] ?? ''); ?></p>
</div>
</div>
</div>
<div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
...
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
<span style="font-family:poppins-semibold,poppins,sans-serif;font-weight:bold;font-size:30px;"><?php echo e($setting['mission_stat_5th_heading'] ?? ''); ?></span>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-description">
<p><?php echo e($setting['mission_stat_5th_description'] ?? ''); ?></p>
</div>
</div>
</div>
<div class="col-md-4 col-sm-4 col-xs-12 image-main-section">
...
<div class="col-md-12 col-sm-12 col-xs-12 image-title">
<span style="font-family:poppins-semibold,poppins,sans-serif;font-weight:bold;font-size:30px;"><?php echo e($setting['mission_stat_6th_heading'] ?? ''); ?></span>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 image-description">
<p><?php echo e($setting['mission_stat_6th_description'] ?? ''); ?></p>
</div>
</div>
</div>
</div>
...
<h2 class="mb-0"><?php echo e($setting['vision_statemtnt_heading'] ?? ''); ?></h2>
</div>
</div>
<div class="banner-bottom3  py-4 px-0"  style="background:#dcf2fa url(<?php echo e(asset('front/assets')); ?>/templates-assets/header/img/hbg.jpg) no-repeat 50% center;background-size: cover;">
                ...
                <div class=" card-site p-3 rounded">
                    ...
                    <div class="media">
                      ...
                      <div class="media-body ml-3 m-auto pl-3" style="min-height:130px">
                        <div style="display: flex;"><h1 class="timer count-title count-number mt-3" data-to="<?php echo e($setting['statement_users_count'] ?? ''); ?>" data-speed="6000" style="color:#008AFC"><?php echo e($setting['statement_users_count']); ?> </h1><span class="text-dark" style="font-size: 35px; margin: 13px;">million</span>
                        </div>
                        
                        <h6><?php echo e($setting['statement_users'] ?? ''); ?></h6>
                      </div>
                    </div>
                    ...
                    <div class="media">
                      ...
                      <div class="media-body ml-3 m-auto pl-3" style="min-height: 130px;">
                        <div style="display: flex;">
                                <h1 class="timer count-title count-number mt-3" data-to="<?php echo e($setting['statement_countries_count'] ??''); ?>" data-speed="6000" style="color:#008AFC"> <?php echo e($setting['statement_countries_count']); ?> </h1><span class="text-dark" style="font-size: 35px; margin: 13px;">countries</span>
                             
                        </div>
                       
                        <?php echo e($setting['statement_countries'] ?? ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/front/our_mission.blade.php ENDPATH**/ ?>