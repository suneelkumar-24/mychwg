            ...
            <div class="card" style="min-height: 458px;">
                <div class="card-body">
                        ...
                        <div class="text-center m-auto">
                            <img class="paypal-logo" src="<?php echo e(asset('front/square.png')); ?>">
                            ...
                            <form method="post" action="<?php echo e(route('homeopath.square.connect')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="form-group1">
                                    <input type="text" class="form-control my-1" name="app_id" value="<?php echo e(\Auth::user()->square_app_id); ?>" placeholder="Application ID" required>
                                </div>
                                <div class="form-group1">
                                    <input type="text" class="form-control my-1" name="access_token" value="<?php echo e(\Auth::user()->square_access_token); ?>" placeholder="Access Token" required>
                                </div>
                                <div class="form-group1">
                                    <input type="text" class="form-control my-1" name="location_id" value="<?php echo e(\Auth::user()->square_location_id); ?>" placeholder="Location ID" required>
