        ...
        <div class="card-content">
                ...
                <div class="permissions mt-2">
                    ...
                    <?php $__currentLoopData = badges(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <input type="radio" name="badge_id" value="<?php echo e($item->id); ?>" id="<?php echo e($item->id); ?>" required="">
                        <label for="<?php echo e($item->id); ?>"><?php echo e($item->title); ?></label>
                        <img src="<?php echo e(asset($item->path)); ?>">
                        </div>
...
<?php echo $__env->make('layouts.advocate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/advocate/get_more_badges.blade.php ENDPATH**/ ?>