                ...
                <tbody>
                    <tr>
                        <td style="padding: 48px 24px 0; color: #161c2d; font-size: 18px; font-weight: 600;">
                            <?php echo e(emailSetting('register_user')->hello ??''); ?>

                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            <?php echo emailSetting('register_user')->desc ??''; ?>

                        </td>
                    </tr>

                    <?php if(emailSetting('register_user')->image??''): ?>
                    <tr>
                       <td style="padding: 15px 24px 15px; color: #8492a6;">
                    ...
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            <?php echo e(emailSetting('register_user')->team??''); ?>
...
<?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/email/user/register_user.blade.php ENDPATH**/ ?>