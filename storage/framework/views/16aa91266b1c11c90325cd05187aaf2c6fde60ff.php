...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  menu-collapsed blank-page " data-open="click" data-menu="vertical-menu-modern" data-col="1-column" style="background : url(<?php echo e(asset('admin/images/pages/vuexy-login-bg.jpg')); ?>) no-repeat center center;">
    <!-- BEGIN: Content-->
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="<?php echo e(asset($setting['logo']) ?? ''); ?>" class="img-fluid align-self-center" alt="LocalServices">
                                    <h1 class="font-large-2 my-1">403 - Unauthorized access!</h1>
                                    <p class="p-2">
                                        It seems that you have not permission to access this route.
                                    </p>
                                    <a class="btn btn-primary btn-lg mt-2" href="<?php echo e(url()->previous()); ?>">Return back</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/errors/403.blade.php ENDPATH**/ ?>