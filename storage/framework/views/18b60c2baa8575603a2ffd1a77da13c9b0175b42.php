...
<form method="POST" action="<?php echo e(route('advocate.events.update', Crypt::encrypt($item->id))); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="col-sm-12">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-8">
                            ...
                            <input type="text" class="form-control" name="title" required="" value="<?php echo e($item->title); ?>">
                        </div>
                    ...
                    <div class="row date-time-selecter">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="append-date-time">
                                ...
                                <?php $__currentLoopData = $item->eventTimings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-6">
                                            <label>Date</label>
                                            <input type="text" class="form-control datepicker date" name="date[]" required="" value="<?php echo e($timing->date); ?>">
                                        </div>
                                        <div class="col-sm-6">
                                            <label>Starts at</label>
                                            <select class="form-control" name="time[]">
                                                <option hidden="" value="<?php echo e($timing->time); ?>"><?php echo e($timing->time); ?></option>
                                                <?php for($i = 1; $i < 24; $i++): ?>
                            ...
                            <div class="text-right mt-2">
                                ...
                                <a class="btn btn-danger btn-sm btn-remove-day-time text-white <?php if(count($item->eventTimings) == 1): ?> d-none <?php endif; ?>">- REMOVE DAY/TIME</a>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-8">
                            ...
                            <input type="text" class="form-control" name="category" required="" value="<?php echo e($item->category); ?>">
                        </div>
                        <div class="col-lg-4 event-input-desctiption-side">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-8">
                            ...
                            <input type="file" class="w-100 dropify" name="thumbnail" data-default-file="<?php echo e(asset($item->thumbnail ?? '')); ?>">
                        </div>
                        <div class="col-lg-4 event-input-desctiption-side">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-8">
                            ...
                            <textarea class="form-control" name="description" required="" rows="9"><?php echo e($item->description); ?></textarea>
                        </div>
                        <div class="col-lg-4 event-input-desctiption-side">
        ...
        <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-8">
                            ...
                            <select class="form-control event-type text-capitalize" name="type">
                                ...
                                <option hidden="" value="<?php echo e($item->type); ?>"><?php echo e($item->type); ?></option>
                    ...
                    <div class="in-person-fields <?php if($item->type == 'virtual'): ?> d-none <?php endif; ?>">
                        
                    <div class="row mb-2">
                        <div class="col-lg-4">
                            <label>VENUE</label>
                            <input type="text" class="form-control" name="venue" value="<?php echo e($item->venue ??''); ?>">
                        </div>

                        <div class="col-lg-4">
                            <label>LOCATION (or NEAR BY)</label>
                            <input type="text" class="form-control" id="point" name="location" placeholder="" value="<?php echo e($item->location ?? ''); ?>">
                            <input type="hidden" id="latitude" name="latitude" value="<?php echo e($item->latitude); ?>">
                            <input type="hidden" id="longitude" name="longitude" value="<?php echo e($item->longitude); ?>">
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-8">
                            <label>HOSTS</label>
                            <input type="text" class="form-control" name="hosts" value="<?php echo e($item->hosts ?? ''); ?>">
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-8">
                            <label>VENDORS</label>
                            <input type="text" class="form-control" name="vendors" value="<?php echo e($item->vendors ?? ''); ?>">
                        </div>
...
<?php echo $__env->make('layouts.advocate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/advocate/events/edit.blade.php ENDPATH**/ ?>