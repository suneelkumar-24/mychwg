<?php $__env->startSection('title', $setting['about_title'] ?? ''); ?>
...
<?php echo $__env->make('front.components.pages_banner', ['heading' => $setting['about_title'] ?? '', 'description' => $setting['about_description'] ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<section class="content">
    <div id="custom_single_page">
        <div class="container">
            <br>
            <p style="text-align:center;"><strong class="gotham-bold"><?php echo e($setting['site_full_name'] ?? ''); ?></strong></p>
            <h5  style="text-align:center;" class="lora-regular"><?php echo e($setting['about_main_heading'] ?? ''); ?></h5>
            <div class="row card-site rounded mt-5">
                ...
                <div class="txt16">
                    <h2 class="txt30 gotham-bold"><?php echo e($setting['about_section_1st_heading'] ?? ''); ?></h2>
                    <p class="gotham-black"><?php echo e($setting['about_section_1st_desctiption'] ?? ''); ?></p>
                    
                </div>
            </div>
            <div class="col-sm-6 p-0">
                <img alt="" src="<?php echo e(asset($setting['about_section_1st_thumbnail'] ?? '')); ?>" class="w-100 p-3">
            </div>
        </div>

        <div class="row dr card-site rounded mt-5">
            <div class="col-sm-6 p-0">
                <img alt="" src="<?php echo e(asset($setting['about_section_2nd_thumbnail'] ?? '')); ?>" class="w-100 p-3">
            </div>
            <div class="col-sm-6 m-auto">
                <div class="text-center">
                ...
                <div class="txt16">
                    <h2 class="txt30 gotham-bold"><?php echo e($setting['about_section_2nd_heading'] ?? ''); ?></h2>
                    <p class="gotham-black"><?php echo e($setting['about_section_2nd_desctiption'] ?? ''); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="row card-site rounded mt-5">
            <div class="col-sm-6 m-auto">
                ...
                <div class="txt16">
                    <h2 class="txt30 gotham-bold"><?php echo e($setting['about_section_3rd_heading'] ?? ''); ?></h2>
                    <p class="gotham-black"><?php echo e($setting['about_section_3rd_desctiption'] ?? ''); ?></p>
                </div>
            </div>
            <div class="col-sm-6 p-0">
                    <img alt="" src="<?php echo e(asset($setting['about_section_3rd_thumbnail'] ?? '')); ?>" class="w-100 p-3">
            </div>
    </div>

    <div class="row dr card-site rounded mt-5">
        <div class="col-sm-6 p-0">
            <img alt="" src="<?php echo e(asset($setting['about_section_4th_thumbnail'] ?? '')); ?>" class="w-100 p-3">
        </div>
        <div class="col-sm-6 m-auto">
            <div class="text-center">
    ...
    <div class="txt16">
        <h2 class="txt30 gotham-bold"><?php echo e($setting['about_section_4th_heading'] ?? ''); ?></h2>
        <p class="gotham-black"><?php echo e($setting['about_section_4th_desctiption'] ?? ''); ?></p>
    </div>
</div>
</div>
<p><br></p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u431718007/domains/mychwg.com/public_html/resources/views/front/about_us.blade.php ENDPATH**/ ?>