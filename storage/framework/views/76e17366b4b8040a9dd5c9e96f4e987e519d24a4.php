...
<section class="content">
    <div id="custom_single_page">
        <div class="container">
            <br>
            <p style="text-align:center;"><strong><?php echo e($setting['site_full_name'] ?? ''); ?></strong></p>
            <h5  style="text-align:center;"><?php echo e($setting['about_main_heading'] ?? ''); ?></h5>
            <div class="row card-site rounded mt-5">
                ...
                <div class="txt16">
                    <h2 class="txt30"><?php echo e($setting['about_section_1st_heading'] ?? ''); ?></h2>
                    <?php echo e($setting['about_section_1st_desctiption'] ?? ''); ?>
        ...
        <div class="row dr card-site rounded mt-5">
            ...
            <div class="col-sm-6 m-auto">
                ...
                <div class="txt16">
                    <h2 class="txt30"><?php echo e($setting['about_section_2nd_heading'] ?? ''); ?></h2>
                    <?php echo e($setting['about_section_2nd_desctiption'] ?? ''); ?>
        ...
        <div class="row card-site rounded mt-5">
            <div class="col-sm-6 m-auto">
                ...
                <div class="txt16">
                    <h2 class="txt30"><?php echo e($setting['about_section_3rd_heading'] ?? ''); ?></h2>
                    <?php echo e($setting['about_section_3rd_desctiption'] ?? ''); ?>
    ...
    <div class="txt16">
        <h2 class="txt30"><?php echo e($setting['about_section_4th_heading'] ?? ''); ?></h2>
        <?php echo e($setting['about_section_4th_desctiption'] ?? ''); ?>
