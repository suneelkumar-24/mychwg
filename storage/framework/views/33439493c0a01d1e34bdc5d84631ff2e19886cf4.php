    ...
    <div class="modal-content">
      ...
      <form method="POST" action="<?php echo e(route('homeopath.appointments.update.holiday')); ?>">
        ...
        <div class="modal-body">
            ...
            <input type="text" class="form-control datepicker font-weight-bold text-center" name="holiday_from" readonly required value="<?php echo e(now()->addDay()->format('Y-m-d')); ?>">



            <label>Holiday Ending to <span class="text-danger">*</span></label>

            <input type="text" class="form-control datepicker font-weight-bold text-center" name="holiday_to" readonly required value="<?php echo e(now()->addDay(2)->format('Y-m-d')); ?>">
