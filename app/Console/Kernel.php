...
class Kernel extends ConsoleKernel
{
     ...
     */
    protected $commands = [
        Commands\ActiveAppointmentsUpdateStatus::class
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('appointmentupdate:cron')
            ->everyTenMinutes()->timezone('America/New_York');
        ...
        Log::notice("Cron called successfully");
        })->dailyAt('01:00');
    }
